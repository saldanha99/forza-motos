  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <h1 className="font-rajdhani font-bold text-3xl text-white mb-3">Carrinho vazio</h1>
        <p className="text-zinc-500 mb-8">Adicione produtos para continuar comprando.</p>
        <Link href="/produtos">
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {items.map((item) => (
            <div key={item.id} className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex gap-4">
              <div className="relative w-20 h-20 bg-zinc-800 rounded overflow-hidden shrink-0">
                {item.imagem ? (
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-medium text-white line-clamp-2">{item.nome}</h3>
        ...
        <div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 sticky top-24">
            <h2 className="font-rajdhani font-bold text-xl text-white mb-4">Resumo</h2>
